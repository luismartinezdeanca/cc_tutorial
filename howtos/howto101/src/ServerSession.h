...
#include "howto101/input/ServerInputMessages.h"
#include "howto101/options/ServerDefaultOptions.h"
...
public:
    ...
    using ServerProtocolOptions = 
        howto101::options::DataViewDefaultOptionsT<
            howto101::options::ServerDefaultOptions
        >;
...
private:
    ...
    using Frame = 
        howto101::frame::Frame<
            Message,
            howto101::input::ServerInputMessages<Message, ServerProtocolOptions>,
